...
#
#
# class OracleGZGetAllProductConnectionPool:
#     """
#     Oracle 连接池，
...
#     @staticmethod
#     def get_engine():
#         if OracleGZGetAllProductConnectionPool._engine is None:
#             # Oracle配置
...
#             oracle_mode = config.get_config_value("split.gz_db.mode")
#             connect_url = config.get_config_value("split.gz_db.connect_url")
#
#             if oracle_mode == "thin":
#                 pass
...
#
#             OracleGZGetAllProductConnectionPool._engine = create_engine(
...
#             )
#         return OracleGZGetAllProductConnectionPool._engine
#
#     @staticmethod
#     def get_session():
#         if OracleGZGetAllProductConnectionPool._session_maker is None:
#             OracleGZGetAllProductConnectionPool._session_maker = sessionmaker(bind=OracleGZGetAllProductConnectionPool.get_engine())
#         return OracleGZGetAllProductConnectionPool._session_maker()
#
#
#
#
#
# def execute_gz_query_sql(sql, params=None):
#     """
#     :param sql:
#     :param params:
#     :return:
...
#     """
#     with OracleGZGetAllProductConnectionPool.get_session() as session:
...
#
#
# def execute_gz_get_all_product_dml_sql(sql, params=None):
#     with OracleGZGetAllProductConnectionPool.get_session() as session:
#         try:
...
#     df = execute_gz_query_sql(sql, params)
#     print(df)
#
#
# def test_dml_sql():
...
#     execute_gz_get_all_product_dml_sql(sql, params)
#
