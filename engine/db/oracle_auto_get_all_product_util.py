...
class OracleAutoGetAllProductConnectionPool:
    """
    Oracle 连接池，
    ...
    @staticmethod
    def get_engine():
        if OracleAutoGetAllProductConnectionPool._engine is None:
            # Oracle配置
            ...
            oracle_mode = config.get_config_value("split.auto_db.mode")
            connect_url = config.get_config_value("split.auto_db.connect_url")
            ...
            OracleAutoGetAllProductConnectionPool._engine = create_engine(
        ...
        return OracleAutoGetAllProductConnectionPool._engine

    @staticmethod
    def get_session():
        if OracleAutoGetAllProductConnectionPool._session_maker is None:
            OracleAutoGetAllProductConnectionPool._session_maker = sessionmaker(bind=OracleAutoGetAllProductConnectionPool.get_engine())
        return OracleAutoGetAllProductConnectionPool._session_maker()
...
def execute_auto_query_sql(sql, params=None):
    ...
    """
    with OracleAutoGetAllProductConnectionPool.get_session() as session:
