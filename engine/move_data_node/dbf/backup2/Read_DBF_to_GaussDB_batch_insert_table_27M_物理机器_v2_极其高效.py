...
my_columns = ('zqjc','zqdm','gzrq','csjc',
              'sjdcq','gjqj','yjlx', 'gjjj',
              'gjsyl', 'evlxzjq','evltx','evljdjz')
...
#start_time = time.time()
# execute_values(cur,"INSERT INTO DBF_2_ORACLE_TABLE_27M "
#                    "(ZQJC, ZQDM, GZRQ, CSJC, SJDCQ, GJQJ, YJLX, GJJJ, GJSYL, EVLXZJQ, EVLTX, EVLJDJZ) VALUES  %s",
#                data_tuples, page_size=1000)

# 使用COPY命令将数据从文件对象加载到数据库中
cur.copy_from(output, 'dbf_2_oracle_table_27m', columns=my_columns)
