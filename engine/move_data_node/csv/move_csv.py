from engine.move_data_node.csv.move_csv_to_oracle import *
from engine.core.context import Context
from engine.cnst.FileType import FileType


def move_csv(flow_node, file_path_and_name, flow_node_csv_config, field_mapping_config_list, context_instance):
    # Move DBF file to Oracle
    move_csv_to_oracle(flow_node, file_path_and_name, flow_node_csv_config, field_mapping_config_list, context_instance)
...
values (1025, '004', 'TJK_JYQS_SHETFQD', '2', '<data>
    ...
    move_csv(flow_node, file_path_and_name, flow_node_txt_config, field_mapping_config_list, context_instance)
